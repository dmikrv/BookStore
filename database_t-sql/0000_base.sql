...
--DROP TABLE IF EXISTS DecommissionedBook;
--DROP TABLE IF EXISTS ContinuationBook;
...
ALTER TABLE Book ADD CONSTRAINT Book_AuthorId_Author_HumanId FOREIGN KEY (AuthorId) REFERENCES Author(HumanId) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE [Order] ADD CONSTRAINT Order_CustomerId_Customer_HumanId FOREIGN KEY (CustomerId) REFERENCES Customer(HumanId) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE Author ADD CONSTRAINT Author_HumanId_Human_id FOREIGN KEY (HumanId) REFERENCES Human(id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE Customer ADD CONSTRAINT Customer_HumanId_Human_id FOREIGN KEY (HumanId) REFERENCES Human(id) ON DELETE CASCADE ON UPDATE CASCADE;